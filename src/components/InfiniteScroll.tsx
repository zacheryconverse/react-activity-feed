import React, { useCallback, useEffect, useRef, forwardRef, PropsWithChildren } from 'react';
...
export const InfiniteScroll = forwardRef<unknown, InfiniteScrollProps>((props, ref) => {
  const {
    children,
    element = 'div',
    hasMore = false,
